...
const TRANSLATIONS = {
  it: {
    ...
    heroText:
      "Analizza progetti Spring Boot, raggruppa i problemi per area tecnica e mostra in modo chiaro cosa correggere, perché conta e quali classi o file sono coinvolti.",
    precisionMode: "Modalità precisa Web/Batch",
    precisionModeText:
      "Regole più selettive, evidenza reale e nessun finding basato solo su import o esempi generici.",
    scopeOnly: "Perimetro attivo",
    scopeOnlyText:
      "Web/API e Spring Batch. Camel e altri profili restano fuori finché non avranno regole dedicate.",
    evidenceFirst: "Evidenza prima di tutto",
    evidenceFirstText:
      "Ogni card parte da file, riga e snippet realmente trovati nel progetto analizzato.",
    impactVisualTitle: "Mappa impatto",
    impactVisualText:
      "Distribuzione immediata delle severità per capire dove intervenire per primo.",
    ...
    folderHelp:
      "Seleziona la cartella principale del progetto, ad esempio quella che contiene il pom.xml.",
    backendFolderPath: "Percorso cartella sul backend",
    backendPathHelp:
      "Serve quando backend e progetto sono sulla stessa macchina o quando Docker monta una cartella sotto /scan.",
    ...
    profileHelp:
      "Spring Guardian rileva automaticamente i moduli Spring dal POM e dal codice. Non devi scegliere il tipo progetto: carica il progetto e avvia la review.",
    automaticProfileTitle: "Analisi automatica Spring",
    automaticProfileText:
      "Carica il progetto: Spring Guardian rileva Web, Security, Batch, JPA, JDBC, Actuator, Validation e OpenAPI prima di applicare le regole.",
    ...
    analysisStepAlternatives:
      "3. Evidenzio alternative Spring concrete al codice manuale.",
    analysisStepProduction:
      "4. Controllo prontezza produzione, azioni e JSON tecnico.",
    noManualProfile:
      "Nessun profilo manuale: Web, Batch e Production readiness vengono riconosciuti dalla scansione.",
    webApi: "API Web / REST",
    batch: "Batch",
    ...
    selectPathError:
      "Inserisci il percorso di una cartella visibile dal backend.",
    ...
    springModulesSubtitle:
      "Capability rilevate dal POM e dal codice: il report applica le regole solo dove il modulo ha senso.",
    productionRules: "Regole produzione",
    productionRulesSubtitle:
      "Rischi di rilascio: configurazione, segreti, Actuator, Maven, profili e prontezza operativa.",
    suggestionsToVerify: "Consigli da verificare",
    suggestionsSubtitle:
      "Note a bassa confidenza o a basso impatto: utili per revisione, ma non trattarle come blocchi senza conferma.",
    ...
    advisorSubtitle:
      "Uso manuale di API Java, componenti di basso livello e alternative Spring più integrate da valutare.",
    advisorOpportunities: "suggerimenti",
    advisorEmptyTitle: "Nessuna alternativa Spring rilevata",
    advisorEmptyText:
      "Questa scansione non ha rilevato API Java manuali o componenti sostituibili con alternative Spring più integrate.",
    actions: "Azioni",
    ...
    showingFirstComponents:
      "Mostro le prime occorrenze rilevanti. Il JSON tecnico contiene l’elenco completo.",
    ...
    examplesHidden:
      "Gli esempi generici non vengono mostrati nella card principale: usa file, riga e snippet reali per verificare il finding.",
    ...
    jsonNote:
      "Questa sezione è pensata per sviluppatori e pipeline CI. Per una lettura funzionale usa Riepilogo, Controlli qualità, Problemi e Azioni.",
    emptyTitle: "Nessuna scansione eseguita",
    emptyText:
      "Carica uno ZIP, seleziona la cartella root del progetto oppure indica un percorso leggibile dal backend.",
    critical: "Critico",
    major: "Alto",
    minor: "Medio",
    info: "Info",
    ...
    decisionBoardText:
      "Il report è ordinato per decisione: prima i blocchi di rilascio, poi i problemi importanti, il debito tecnico, gli advisor Spring e infine le note informative.",
    ...
    importantLaneText:
      "Alti: rischi concreti per sicurezza, architettura o manutenzione.",
    improvementsLane: "Debito tecnico rilevante",
    improvementsLaneText:
      "Medi: miglioramenti da pianificare nel backlog tecnico.",
    advisorLane: "Suggerimenti Spring",
    advisorLaneText:
      "Advisor: alternative Spring e modernizzazione, non blocchi immediati.",
    ...
    workspaceSubtitle:
      "Carica un progetto e ottieni una review leggibile, navigabile e orientata alla correzione.",
    dashboardTitle: "Dashboard progetto",
    dashboardSubtitle:
      "Situazione immediata, priorità e percorsi di approfondimento.",
    architectTitle: "Architect Mode",
    architectSubtitle:
      "Maturity score, mappa architetturale, cicli, roadmap e checklist di modernizzazione.",
    ...
    quickWinsText:
      "Correzioni piccole che sbloccano qualità e leggibilità rapidamente.",
    architecturalRefactorings: "Refactoring architetturali",
    architecturalRefactoringsText:
      "Interventi su layer, package, confini e dipendenze tra moduli.",
    productionFixes: "Fix produzione",
    productionFixesText:
      "Azioni per rendere la app osservabile, sicura e pronta al rilascio.",
    productionReadinessTitle: "Production Readiness Advisor",
    risks: "Rischi",
    strengths: "Punti forti",
    noProductionRisks:
      "Nessun rischio produzione rilevante rilevato dalle regole attive.",
    findingsTitle: "Problemi rilevati",
    findingsSubtitle:
      "Filtra per severità, area o tipo e apri solo ciò che devi correggere.",
    alternativesTitle: "Spring Alternatives",
    alternativesPageSubtitle:
      "Alternative concrete Spring-first per modernizzare il codice senza suggerimenti generici.",
    qualityTitle: "Qualità e readiness",
    qualitySubtitle:
      "Gate, moduli rilevati, produzione, suggerimenti e azioni in un’unica vista operativa.",
    missionTitle: "Missione del progetto",
    missionSubtitle:
      "Spring Guardian nasce per rendere le review architetturali Spring più chiare, ripetibili e utili ai team enterprise.",
    missionBody:
      "L’obiettivo è diventare uno standard aziendale per audit, modernization, governance, onboarding, code review e refactoring di progetti Java/Spring reali.",
    missionPointOne: "Specializzato su Spring, non un analyzer generico.",
    missionPointTwo:
      "Evidence-first: ogni finding deve portare a file, classe, riga o configurazione.",
    missionPointThree:
      "Remediation concreta con alternative Spring ufficiali e priorità di intervento.",
    missionPointFour:
      "CLI-first per CI, ma con frontend e report professionali per team e stakeholder.",
    contactTitle: "Contatti e contributi",
    contactSubtitle:
      "Hai idee, regole Spring da proporre o vuoi migliorare UX, report e documentazione?",
    contactEmailLabel: "Email",
    linkedinPlaceholder: "www.linkedin.com/in/simone-meneghetti-28525a15a",
    mediumPlaceholder: "https://medium.com/@persolenom",
    contributeTitle: "Contribuisci liberamente",
    contributeText:
      "Se vuoi contribuire, modifica pure il progetto: aggiungi rule, fixture, test, miglioramenti frontend, documentazione o report. Ogni contributo che rende Spring Guardian più utile ai team Java/Spring è benvenuto.",
    reportLockedTitle: "Prima esegui una scansione",
    reportLockedText:
      "La dashboard, i problemi, le alternative, i gate e il JSON tecnico diventano disponibili appena analizzi un progetto.",
    ...
    contactCallout:
      "Per domande, idee o collaborazione scrivi a s.meneghetti7@gmail.com.",
    contributionHint:
      "Il progetto è pensato per evolvere con contributi pratici: regole Spring, UX, test e documentazione.",
    openArchitectureGraph: "Apri grafico architetturale",
    closeDialog: "Chiudi",
    expectedSpringFlow: "Flusso Spring consigliato",
    detectedViolations: "Violazioni rilevate",
    noArchitectureViolations:
      "Nessuna violazione strutturale evidente nella mappa corrente.",
    upgradeWhy: "Perché è consigliato",
    upgradeActions: "Azioni suggerite",
    upgradeEffort: "Sforzo",
    upgradeEvidence: "Evidenza",
  ...
  en: {
    ...
    heroText:
      "Analyze Spring Boot projects, group findings by technical area and clearly show what should be fixed, why it matters and which classes or files are involved.",
    precisionMode: "Precise Web/Batch mode",
    precisionModeText:
      "More selective rules, real evidence and no findings based only on imports or generic examples.",
    scopeOnly: "Active scope",
    scopeOnlyText:
      "Web/API and Spring Batch. Camel and other profiles stay out until dedicated rules are available.",
    evidenceFirst: "Evidence first",
    evidenceFirstText:
      "Every card starts from file, line and snippet actually found in the analyzed project.",
    impactVisualTitle: "Impact map",
    impactVisualText:
      "Immediate severity distribution to understand where to act first.",
    ...
    folderHelp:
      "Select the project root folder, for example the one containing pom.xml.",
    backendFolderPath: "Backend folder path",
    backendPathHelp:
      "Use this when the backend and the project are on the same machine or when Docker mounts a folder under /scan.",
    ...
    profileHelp:
      "Spring Guardian detects Spring modules automatically from the POM and source code. You do not need to choose a project type: load the project and start the review.",
    automaticProfileTitle: "Automatic Spring analysis",
    automaticProfileText:
      "Load the project: Spring Guardian detects Web, Security, Batch, JPA, JDBC, Actuator, Validation and OpenAPI before applying rules.",
    ...
    analysisStepAlternatives:
      "3. Highlight concrete Spring alternatives to manual code.",
    analysisStepProduction:
      "4. Check production readiness, actions and technical JSON.",
    noManualProfile:
      "No manual profile: Web, Batch and production readiness are inferred from the scan.",
    webApi: "Web / REST API",
    batch: "Batch",
    ...
    springModulesSubtitle:
      "Capabilities detected from the POM and code: the report applies rules only where the module makes sense.",
    productionRules: "Production Rules",
    productionRulesSubtitle:
      "Release risks: configuration, secrets, Actuator, Maven, profiles and operational readiness.",
    suggestionsToVerify: "Suggestions to Verify",
    suggestionsSubtitle:
      "Low-confidence or low-impact notes: useful for review, but do not treat them as blockers without confirmation.",
    ...
    advisorSubtitle:
      "Manual Java objects, low-level APIs and modern Spring alternatives worth evaluating.",
    advisorOpportunities: "suggestions",
    advisorEmptyTitle: "No Spring alternative detected",
    advisorEmptyText:
      "This scan did not find manual Java objects or APIs that should be replaced by more integrated Spring alternatives.",
    actions: "Actions",
    ...
    showingFirstComponents:
      "Showing the first relevant occurrences. The technical JSON contains the full list.",
    ...
    examplesHidden:
      "Generic examples are not shown in the main card: use file, line and real snippets to verify the finding.",
    ...
    jsonNote:
      "This section is meant for developers and CI pipelines. Functional reading is available in Overview, Quality gates, Findings and Actions.",
    emptyTitle: "No scan executed",
    emptyText:
      "Upload a ZIP, select the project root folder or enter a backend-readable path.",
    critical: "Critical",
    major: "High",
    minor: "Medium",
    info: "Info",
    ...
    decisionBoardText:
      "The report is organized by decision impact: release blockers first, then important issues, technical debt, Spring advisors and informational notes.",
    blockersLane: "Production blockers",
    blockersLaneText:
      "Critical findings: fix these before considering the release.",
    importantLane: "Fix before release",
    importantLaneText:
      "High findings: concrete security, architecture or maintenance risks.",
    improvementsLane: "Relevant technical debt",
    improvementsLaneText:
      "Medium findings: plan these in the technical backlog.",
    advisorLane: "Spring suggestions",
    advisorLaneText:
      "Advisor findings: Spring alternatives and modernization, not immediate blockers.",
    informationLane: "Informational notes",
    informationLaneText:
      "Info findings: low-impact opportunities and best practices.",
    openLane: "Open",
    navScan: "Scan",
    navOverview: "Dashboard",
    navArchitect: "Architect Mode",
    ...
    workspaceSubtitle:
      "Load a project and get a readable, navigable and fix-oriented review.",
    dashboardTitle: "Project dashboard",
    dashboardSubtitle:
      "Immediate status, priorities and guided drill-down paths.",
    architectTitle: "Architect Mode",
    architectSubtitle:
      "Maturity score, architecture map, cycles, roadmap and modernization checklist.",
    ...
    download: "Download",
    quickWins: "Quick wins",
    quickWinsText: "Small fixes that quickly unlock readability and quality.",
    architecturalRefactorings: "Architectural refactorings",
    architecturalRefactoringsText:
      "Layer, package, boundary and module dependency improvements.",
    productionFixes: "Production fixes",
    productionFixesText:
      "Actions to make the app observable, secure and release-ready.",
    productionReadinessTitle: "Production Readiness Advisor",
    risks: "Risks",
    strengths: "Strengths",
    noProductionRisks:
      "No relevant production risk detected by the enabled rules.",
    findingsTitle: "Detected findings",
    findingsSubtitle:
      "Filter by severity, area or type and open only what you need to fix.",
    alternativesTitle: "Spring Alternatives",
    alternativesPageSubtitle:
      "Concrete Spring-first alternatives to modernize code without generic advice.",
    qualityTitle: "Quality and readiness",
    qualitySubtitle:
      "Gates, detected modules, production checks, suggestions and actions in one operational view.",
    missionTitle: "Project mission",
    missionSubtitle:
      "Spring Guardian makes Spring architecture reviews clearer, repeatable and useful for enterprise teams.",
    missionBody:
      "The goal is to become a company standard for audits, modernization, governance, onboarding, code review and refactoring of real Java/Spring projects.",
    missionPointOne: "Specialized on Spring, not a generic analyzer.",
    missionPointTwo:
      "Evidence-first: every finding should point to a file, class, line or configuration.",
    missionPointThree:
      "Concrete remediation with official Spring alternatives and intervention priority.",
    missionPointFour:
      "CLI-first for CI, with professional frontend and reports for teams and stakeholders.",
    contactTitle: "Contact and contributions",
    contactSubtitle:
      "Have ideas, Spring rules to propose, or UX/report/documentation improvements?",
    contactEmailLabel: "Email",
    linkedinPlaceholder: "www.linkedin.com/in/simone-meneghetti-28525a15a",
    mediumPlaceholder: "https://medium.com/@persolenom",
    contributeTitle: "Contribute freely",
    contributeText:
      "To contribute, modify the project directly: add rules, fixtures, tests, frontend improvements, documentation or reports. Every contribution that makes Spring Guardian more useful for Java/Spring teams is welcome.",
    reportLockedTitle: "Run a scan first",
    reportLockedText:
      "Dashboard, findings, alternatives, gates and technical JSON become available as soon as a project is analyzed.",
    newScan: "New scan",
    ...
    contactCallout:
      "For questions, ideas or collaboration write to s.meneghetti7@gmail.com.",
    contributionHint:
      "The project is designed to evolve through practical contributions: Spring rules, UX, tests and documentation.",
    openArchitectureGraph: "Open architecture graph",
    closeDialog: "Close",
    expectedSpringFlow: "Recommended Spring flow",
    detectedViolations: "Detected violations",
    noArchitectureViolations:
      "No evident structural violation in the current map.",
    upgradeWhy: "Why it is recommended",
    upgradeActions: "Suggested actions",
...
export class AppComponent {
  ...
  readonly architectureGraphDialogOpen = signal(false);
  ...
  readonly categories = computed(() => {
    ...
    return [
      ...new Set(current.findings.map((finding) => finding.category)),
    ].sort();
  });
  ...
  readonly findingTypes = computed(() => {
    ...
    return [
      ...new Set(current.findings.map((finding) => this.findingType(finding))),
    ].sort((left, right) =>
      this.findingTypeLabel(left).localeCompare(this.findingTypeLabel(right)),
    );
  });
  ...
  readonly springAdvisorFindings = computed(() => {
    ...
    return current.findings.filter((finding) =>
      this.isSpringAdvisorFinding(finding),
    );
  });
    ...
    return [
      this.moduleCard(
        ...
        c.usesSpringWeb
          ...
          : it
            ? "Nessun segnale Web MVC/WebFlux"
            : "No Web MVC/WebFlux signal",
        c.usesSpringWeb
          ? it
            ? "Regole Web/API attive: controller, DTO, validazione, error handling e OpenAPI."
            : "Web/API rules active: controllers, DTOs, validation, error handling and OpenAPI."
          : it
            ? "Le regole Web restano inattive se il modulo non è presente."
            : "Web rules stay inactive when the module is not present.",
      ),
      this.moduleCard(
        "Spring Security",
        c.usesSpringSecurity,
        c.usesSpringSecurity
          ? "spring-boot-starter-security / SecurityFilterChain"
          : it
            ? "Nessun segnale Spring Security"
            : "No Spring Security signal",
        c.usesSpringSecurity
          ? it
            ? "Regole Security attive: matcher, chain, CSRF, header e configurazione."
            : "Security rules active: matchers, chains, CSRF, headers and configuration."
          : it
            ? "Le regole Security non vengono applicate senza segnali reali."
            : "Security rules are not applied without real signals.",
      ),
      this.moduleCard(
        "Spring Batch",
        c.usesSpringBatch,
        c.usesSpringBatch
          ? "spring-batch-core / @EnableBatchProcessing"
          : it
            ? "Nessun segnale Spring Batch"
            : "No Spring Batch signal",
        c.usesSpringBatch
          ? it
            ? "Regole Batch attive: job, step, reader, writer, retry, skip e restartability."
            : "Batch rules active: jobs, steps, readers, writers, retry, skip and restartability."
          : it
            ? "Le regole Batch restano inattive se il progetto non è Batch."
            : "Batch rules stay inactive when the project is not Batch.",
      ),
      this.moduleCard(
        "Spring Data JPA",
        c.usesJpa,
        ...
        c.usesJpa
          ? it
            ? "Regole persistenza abilitate dove applicabili."
            : "Persistence rules enabled where applicable."
          : it
            ? "I controlli JPA restano inattivi."
            : "JPA checks stay inactive.",
      ),
      this.moduleCard(
        "Actuator",
        c.usesActuator,
        c.usesActuator
          ...
          : it
            ? "Actuator non rilevato"
            : "Actuator not detected",
        c.usesActuator
          ? it
            ? "Health, info, metriche e readiness possono essere valutate."
            : "Health, info, metrics and readiness can be reviewed."
          : it
            ? "Consigliato per prontezza produzione e osservabilità."
            : "Recommended for production readiness and observability.",
      ),
      this.moduleCard(
        "Bean Validation",
        c.usesValidation,
        c.usesValidation
          ...
          : it
            ? "Validation non rilevata"
            : "Validation not detected",
        c.usesValidation
          ? it
            ? "La validazione degli input può essere valutata."
            : "Input validation can be reviewed."
          : it
            ? "Consigliata per DTO e request body Web/API."
            : "Recommended for Web/API DTOs and request bodies.",
      ),
      this.moduleCard(
        "OpenAPI",
        c.usesOpenApi,
        c.usesOpenApi
          ...
          : it
            ? "OpenAPI non rilevato"
            : "OpenAPI not detected",
        c.usesOpenApi
          ? it
            ? "La documentazione API può essere valutata."
            : "API documentation can be reviewed."
          : it
            ? "Consigliato per API pubbliche o interne governate."
            : "Recommended for public or governed internal APIs.",
      ),
    ];
  });
  ...
  readonly productionFindings = computed(() => {
    ...
    return current.findings.filter((finding) =>
      this.isProductionFinding(finding),
    );
  });
  ...
  readonly suggestionFindings = computed(() => {
    ...
    return current.findings.filter((finding) =>
      this.isSuggestionFinding(finding),
    );
  });
  ...
  readonly problemTypeSummaries = computed(() => {
    ...
    const groups = new Map<string, FindingGroup[]>();
    for (const finding of current.findings.filter(
      (item) => !this.isSpringAdvisorFinding(item),
    )) {
  ...
  readonly problemGroups = computed(() => {
    ...
    return Array.from(groups.entries())
      ...
      .sort(
        (left, right) =>
          this.problemTypeRank(left.type) - this.problemTypeRank(right.type) ||
  ...
  readonly decisionLanes = computed(() => {
    ...
    return [
      {
        lane: "BLOCKERS" as DecisionLane,
        title: this.t("blockersLane"),
        text: this.t("blockersLaneText"),
        count: this.decisionCount(current, "BLOCKERS"),
      },
      {
        lane: "IMPORTANT" as DecisionLane,
        title: this.t("importantLane"),
        text: this.t("importantLaneText"),
        count: this.decisionCount(current, "IMPORTANT"),
      },
      {
        lane: "IMPROVEMENTS" as DecisionLane,
        title: this.t("improvementsLane"),
        text: this.t("improvementsLaneText"),
        count: this.decisionCount(current, "IMPROVEMENTS"),
      },
      {
        lane: "ADVISOR" as DecisionLane,
        title: this.t("advisorLane"),
        text: this.t("advisorLaneText"),
        count: this.decisionCount(current, "ADVISOR"),
      },
      {
        lane: "INFORMATION" as DecisionLane,
        title: this.t("informationLane"),
        text: this.t("informationLaneText"),
        count: this.decisionCount(current, "INFORMATION"),
      },
    ];
  });
  ...
  readonly filteredFindings = computed(() => {
    ...
    return current.findings.filter((finding) => {
      ...
      const includeAdvisor =
        activeLane === "ADVISOR" || this.activeTab() === "advisor";
      if (advisor && !includeAdvisor) {
        return false;
      }
      const matchesLane =
        activeLane === null || this.inDecisionLane(finding, activeLane);
      const matchesSeverity =
        this.severityFilter === "ALL" ||
        finding.severity === this.severityFilter;
      const matchesCategory =
        this.categoryFilter === "ALL" ||
        finding.category === this.categoryFilter;
      const matchesType =
        this.typeFilter === "ALL" ||
        this.findingType(finding) === this.typeFilter;
      const searchable = [
        finding.ruleId,
  ...
  readonly totalFindingOccurrences = computed(() => {
    ...
    return current.findings.reduce(
      (total, finding) => total + finding.occurrences,
      0,
    );
  });
  ...
  readonly activeModuleCount = computed(() => {
    ...
    return this.capabilityItems(current).filter(
      (item) => item !== this.t("noFindings"),
    ).length;
  });
  ...
  readonly attentionGateCount = computed(() => {
    ...
    return current.qualityGates.filter(
      (gate) => gate.status !== "PASS" && gate.status !== "OK",
    ).length;
  });
  ...
  scan(): void {
    ...
    if (this.uploadMode() === "folder") {
      ...
      this.currentScanSource.set(
        this.selectedFolderName() ?? this.t("selectedFolderFallback"),
      );
  ...
  severityPercent(
    ...
    const total = report.findings.reduce(
  ...
  firstComponent(finding: FindingGroup): AffectedComponent | null {
    return finding.affectedComponents.length > 0
      ? finding.affectedComponents[0]
      : null;
  }
  ...
  openArchitectureGraph(): void {
    this.architectureGraphDialogOpen.set(true);
  }

  closeArchitectureGraph(): void {
    this.architectureGraphDialogOpen.set(false);
  }

  architectureRiskCount(): number {
    const map = this.report()?.architectMode?.architectureMap;
    if (!map) {
      return 0;
    }
    return (
      map.modules.reduce((total, module) => total + module.risks.length, 0) +
      map.cycles.length
    );
  }

  downloadArchitectArtifact(
    kind: "checklist" | "plan" | "mermaid" | "openrewrite",
  ): void {
    const current = this.report();
    const architect = current?.architectMode;
    if (!current || !architect) {
      return;
    }

    const baseName = `spring-guardian-${current.projectName || "architect-mode"}`;
    const artifact = (() => {
      if (kind === "checklist") {
        return {
          filename: `${baseName}-checklist.json`,
          type: "application/json",
          content: JSON.stringify(
            architect.modernizationPlan.checklist,
            null,
            2,
          ),
        };
      ...
      if (kind === "plan") {
        return {
          filename: `${baseName}-modernization-plan.md`,
          type: "text/markdown",
          content:
            architect.modernizationPlan.markdown ||
            "# Spring Guardian Modernization Plan\n",
        };
      }
      if (kind === "mermaid") {
        return {
          filename: `${baseName}-module-map.mmd`,
          type: "text/plain",
          content: architect.architectureMap.mermaidDiagram,
        };
      }
      return {
        filename: `${baseName}-openrewrite-suggestions.yml`,
        type: "application/yaml",
        content: architect.openRewritePlan.yaml,
      };
    })();

    this.downloadText(artifact.filename, artifact.content, artifact.type);
  }
  ...
  exportJson(): void {
    ...
    this.downloadText(
      `spring-guardian-${current.projectName || "report"}.json`,
  ...
  findingType(finding: FindingGroup): string {
    ...
    if (
      finding.affectedComponents.some(
        (component) => component.type === "MAVEN_POM",
      )
    ) {
      return "POM";
    }
    if (
      finding.affectedComponents.some(
        (component) => component.type === "CONFIG_FILE",
      )
    ) {
    ...
    if (
      finding.affectedComponents.some(
        (component) => component.type === "TEST_CLASS",
      )
    ) {
      return "TEST";
    }
  ...
  isSpringAdvisorFinding(finding: FindingGroup): boolean {
    return (
      finding.findingType === "SPRING_ALTERNATIVE" ||
      finding.category === "Spring Alternative Advisor" ||
      finding.ruleId.startsWith("ADV") ||
      /^SPR(06[4-9]|07[0-9]|08[0-9]|090)/.test(finding.ruleId)
    );
  }

  advisorCount(current: ArchitectureReviewReport): number {
    return current.findings
      .filter((finding) => this.isSpringAdvisorFinding(finding))
      .reduce((total, finding) => total + finding.occurrences, 0);
  }
  ...
  ruleCode(ruleId: string): string {
    return (
      ruleId.match(
        /^(SPR_ALT\d+|SPR|SEC|WEB|BAT|CLD|OBS|POM|ADV|ARCH|CAP)\d*/,
      )?.[0] ?? ruleId
    );
  }
  ...
  moduleCard(
    ...
    return {
      ...
      description,
      status: active
        ? this.t("capabilityDetected")
        : this.t("capabilityMissing"),
    };
  }
  ...
  advisorArea(finding: FindingGroup): string {
    ...
    if (
      ...
      return italian
        ? "Thread, asincronia e schedulazione"
        : "Threads, async and scheduling";
    if (
      ["ADV001", "ADV002", "ADV041", "ADV062", "ADV063", "ADV083"].includes(
        code,
      ) ||
      code === "SPR064"
    )
